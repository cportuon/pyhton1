...
'''La función acepta un parámetro el cual contiene el estado
...
al usuario acerca de su movimiento, verifica la entrada y
actualiza el tablero acorde a la decisión del usuario.'''
...
'''La función examina el tablero y construye una lista de todos
los cuadros vacíos. La lista esta compuesta por tuplas, cada tupla
...
si el jugador que utiliza las 'O's o las 'X's ha ganado el juego.'''
